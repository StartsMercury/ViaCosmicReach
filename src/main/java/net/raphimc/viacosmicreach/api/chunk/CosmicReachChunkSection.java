...
public record CosmicReachChunkSection(IBlockData<Integer> blockData, ISkylightData skylightData, IBlockLightData blockLightData, List<CosmicReachBlockEntity> blockEntities) {
}
